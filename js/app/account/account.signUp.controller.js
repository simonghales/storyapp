...
SignUpCTRL.$inject = ['$rootScope', '$scope', 'AuthenticationResource', 'UserResource'];

/* @ngInject */
function SignUpCTRL($rootScope, $scope, AuthenticationResource, UserResource) {
